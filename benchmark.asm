...
int main(int argc, char *argv[])
{
  ...
  int j;
  psinfo();
  17:	e8 3f 04 00 00       	call   45b <psinfo>
  int stime=200;
  for (j = 0; j < number_of_processes; j++)
  1c:	a1 4c 0b 00 00       	mov    0xb4c,%eax
  21:	85 c0                	test   %eax,%eax
  23:	7e 4f                	jle    74 <main+0x74>
  ...
  27:	be 50 00 00 00       	mov    $0x50,%esi
  2c:	eb 20                	jmp    4e <main+0x4e>
  2e:	66 90                	xchg   %ax,%ax
    if (pid == 0)
  ...
  3a:	83 c3 01             	add    $0x1,%ebx
       set_priority(100-(20+j),pid); // will only matter for PBS, comment it out if not implemented yet (better priorty for more IO intensive jobs)
  3d:	50                   	push   %eax
  3e:	e8 20 04 00 00       	call   463 <set_priority>
  43:	83 c4 10             	add    $0x10,%esp
  for (j = 0; j < number_of_processes; j++)
  46:	39 1d 4c 0b 00 00    	cmp    %ebx,0xb4c
  4c:	7e 26                	jle    74 <main+0x74>
    int pid = fork();
  4e:	e8 58 03 00 00       	call   3ab <fork>
    if (pid < 0)
  ...
  5a:	83 c3 01             	add    $0x1,%ebx
      printf(1, "Fork failed\n");
  5d:	68 88 08 00 00       	push   $0x888
  62:	6a 01                	push   $0x1
  64:	e8 b7 04 00 00       	call   520 <printf>
      continue;
  69:	83 c4 10             	add    $0x10,%esp
  for (j = 0; j < number_of_processes; j++)
  6c:	39 1d 4c 0b 00 00    	cmp    %ebx,0xb4c
  72:	7f da                	jg     4e <main+0x4e>
    }
  }
  for (j = 0; j < number_of_processes+5; j++)
  74:	83 3d 4c 0b 00 00 fc 	cmpl   $0xfffffffc,0xb4c
  7b:	7c 17                	jl     94 <main+0x94>
  7d:	31 db                	xor    %ebx,%ebx
  7f:	90                   	nop
  {
    wait();
  80:	e8 36 03 00 00       	call   3bb <wait>
  for (j = 0; j < number_of_processes+5; j++)
  85:	a1 4c 0b 00 00       	mov    0xb4c,%eax
  ...
  a3:	39 05 4c 0b 00 00    	cmp    %eax,0xb4c
  a9:	0f 8e 86 00 00 00    	jle    135 <main+0x135>
  int stime=200;
  af:	be c8 00 00 00       	mov    $0xc8,%esi
  b4:	eb 45                	jmp    fb <main+0xfb>
  b6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  bd:	8d 76 00             	lea    0x0(%esi),%esi
          sleep(stime); //io time
  c0:	83 ec 0c             	sub    $0xc,%esp
  c3:	56                   	push   %esi
  c4:	e8 7a 03 00 00       	call   443 <sleep>
          if ((k % 2) == 1) 
  c9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  cc:	83 c4 10             	add    $0x10,%esp
  cf:	89 c2                	mov    %eax,%edx
  d1:	c1 ea 1f             	shr    $0x1f,%edx
  d4:	01 d0                	add    %edx,%eax
  d6:	83 e0 01             	and    $0x1,%eax
  d9:	29 d0                	sub    %edx,%eax
            stime += 50;
  db:	8d 56 32             	lea    0x32(%esi),%edx
  de:	83 ee 32             	sub    $0x32,%esi
  e1:	83 f8 01             	cmp    $0x1,%eax
  e4:	0f 44 f2             	cmove  %edx,%esi
      for (volatile int k = 0; k < number_of_processes; k++)
  e7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  ea:	83 c0 01             	add    $0x1,%eax
  ed:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  f0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  f3:	3b 05 4c 0b 00 00    	cmp    0xb4c,%eax
  f9:	7d 3a                	jge    135 <main+0x135>
        if (k <= j)
  fb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  fe:	39 d8                	cmp    %ebx,%eax
 100:	7e be                	jle    c0 <main+0xc0>
          if (k==j) 
 102:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 105:	39 d8                	cmp    %ebx,%eax
 107:	74 36                	je     13f <main+0x13f>
          for (i = 0; i < 100000000; i++); // was acting like sleep 
 109:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
 110:	8b 45 e0             	mov    -0x20(%ebp),%eax
 113:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
 118:	7f cd                	jg     e7 <main+0xe7>
 11a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 120:	8b 45 e0             	mov    -0x20(%ebp),%eax
 123:	83 c0 01             	add    $0x1,%eax
 126:	89 45 e0             	mov    %eax,-0x20(%ebp)
 129:	8b 45 e0             	mov    -0x20(%ebp),%eax
 12c:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
 131:	7e ed                	jle    120 <main+0x120>
 133:	eb b2                	jmp    e7 <main+0xe7>
       psinfo();
 135:	e8 21 03 00 00       	call   45b <psinfo>
      exit();
 13a:	e8 74 02 00 00       	call   3b3 <exit>
            sleep(100);
 13f:	83 ec 0c             	sub    $0xc,%esp
 142:	6a 64                	push   $0x64
 144:	e8 fa 02 00 00       	call   443 <sleep>
 149:	83 c4 10             	add    $0x10,%esp
 14c:	eb bb                	jmp    109 <main+0x109>
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	eb 1a                	jmp    6c0 <printf+0x1a0>
          s = "(null)";
 6a6:	bb 95 08 00 00       	mov    $0x895,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f5:	a1 50 0b 00 00       	mov    0xb50,%eax
{
 ...
 716:	73 10                	jae    728 <free+0x38>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 50 0b 00 00       	mov    %eax,0xb50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 78d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 790:	8b 3d 50 0b 00 00    	mov    0xb50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d9:	8b 3d 50 0b 00 00    	mov    0xb50,%edi
 ...
 802:	e8 e9 fe ff ff       	call   6f0 <free>
  return freep;
 807:	a1 50 0b 00 00       	mov    0xb50,%eax
 ...
 834:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 837:	a3 50 0b 00 00       	mov    %eax,0xb50
}
 ...
 84e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 50 0b 00 00 54 	movl   $0xb54,0xb50
 857:	0b 00 00 
    base.s.size = 0;
 85a:	bf 54 0b 00 00       	mov    $0xb54,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 54 0b 00 00 54 	movl   $0xb54,0xb54
 866:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 86b:	c7 05 58 0b 00 00 00 	movl   $0x0,0xb58
 872:	00 00 00 
    if(p->s.size >= nunits){
