...
int main(int argc, char* argv[])
{
  ...
  16:	8b 59 04             	mov    0x4(%ecx),%ebx
    //fork
    int pid = fork();
  19:	e8 9d 02 00 00       	call   2bb <fork>
    if(pid == 0)
  1e:	85 c0                	test   %eax,%eax
  20:	75 16                	jne    38 <main+0x38>
    {
        //printf(1,"Executing %s\n",argv[1]);
        //execute the given program
        exec(argv[1],argv+1);
  22:	8d 43 04             	lea    0x4(%ebx),%eax
  25:	51                   	push   %ecx
  26:	51                   	push   %ecx
  27:	50                   	push   %eax
  28:	ff 73 04             	pushl  0x4(%ebx)
  2b:	e8 cb 02 00 00       	call   2fb <exec>
  30:	83 c4 10             	add    $0x10,%esp
        int status;
        status = waitx(&waittime,&runtime);
        //print to stdout
        printf(1,"Status is %d, Wait time is %d, Running time is %d\n",status,waittime,runtime);
    }
    exit();
  ...
  38:	50                   	push   %eax
  39:	50                   	push   %eax
  3a:	8d 45 f4             	lea    -0xc(%ebp),%eax
  3d:	50                   	push   %eax
  3e:	8d 45 f0             	lea    -0x10(%ebp),%eax
  41:	50                   	push   %eax
  42:	e8 1c 03 00 00       	call   363 <waitx>
        printf(1,"Status is %d, Wait time is %d, Running time is %d\n",status,waittime,runtime);
  47:	5a                   	pop    %edx
  ...
  54:	6a 01                	push   $0x1
  56:	e8 d5 03 00 00       	call   430 <printf>
  5b:	83 c4 20             	add    $0x20,%esp
  5e:	eb d3                	jmp    33 <main+0x33>
