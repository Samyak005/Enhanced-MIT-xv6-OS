...
int main(int argc, char* argv[])
{
  ...
  2f:	53                   	push   %ebx
  30:	50                   	push   %eax
  31:	e8 2d 03 00 00       	call   363 <set_priority>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	eb 1a                	jmp    5c0 <printf+0x1a0>
          s = "(null)";
 5a6:	bb a2 07 00 00       	mov    $0x7a2,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f5:	a1 5c 0a 00 00       	mov    0xa5c,%eax
{
 ...
 616:	73 10                	jae    628 <free+0x38>
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	a3 5c 0a 00 00       	mov    %eax,0xa5c
}
 647:	5e                   	pop    %esi
 648:	5f                   	pop    %edi
 649:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 68d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 690:	8b 3d 5c 0a 00 00    	mov    0xa5c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
